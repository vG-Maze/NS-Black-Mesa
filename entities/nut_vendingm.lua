		...
		if (activator:IsCombine()) then
			if (activator:KeyDown(IN_SPEED) and button and stocks[button]) then
				...
				if (!activator:HasMoney(25)) then
					return activator:SendOverlayText("INSUFFICIENT FUNDS (25 DOLLARS) TO REFILL MACHINE.")
				else
					activator:SendOverlayText("25 DOLLARS HAVE BEEN TAKEN TO REFILL MACHINE.")
